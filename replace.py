...
# 実行設定
input_md = r"D:\PycharmProjects\RL_research\policy_grad_theorem.md"   # 変換元のファイル名
output_md = r"D:\PycharmProjects\RL_research\policy_grad_theorem_converted.md" # 変換後のファイル名
is_note = True
