...
# 実行設定
input_md = r"D:\PycharmProjects\Reinforce-Learning-Study\miulti-agent\petting_zoo\src\2_boxing\doc\how_to_implement.md"   # 変換元のファイル名
output_md = r"D:\PycharmProjects\Reinforce-Learning-Study\miulti-agent\petting_zoo\src\2_boxing\doc\how_to_implement.md" # 変換後のファイル名
is_note = False
