...
# 実行設定
input_md = r"D:\PycharmProjects\Reinforce-Learning-Study\basic\doc\0_marcov_chain.md"   # 変換元のファイル名
output_md = r"D:\PycharmProjects\Reinforce-Learning-Study\basic\doc\0_marcov_chain.md" # 変換後のファイル名
is_note = False
