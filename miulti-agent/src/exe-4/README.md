...
### 4. 現状
学習は走るようになりましたが、1エピソード回すのに5分かかっています。
この状態だと、エージェントがそれらしい動作を始める可能性がある1000エピソードまで5000分→3.5日くらいかかりそうです。
学習できるサーバーが欲しいと思う今日この頃です。

![1776574362099](image/README/1776574362099.png)
