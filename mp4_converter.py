...
if __name__ == "__main__":
    ...
    import os
    path_input = r"D:\PycharmProjects\Reinforce-Learning-Study\miulti-agent\petting_zoo\src\2_boxing\doc\image\4_train_result\boxing_vs_random_reward_0 (2).mp4"
